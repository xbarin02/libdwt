...
#else
	float dec_phi[5] = { -0.17677669, +0.35355338, +1.06066012, +0.35355338, -0.17677669 };
	float dec_psi[3] =              { -0.35355338, +0.70710677, -0.35355338 };
	float rec_phi[3] =              { +0.35355338, +0.70710677, +0.35355338 };
	float rec_psi[5] = { -0.17677669, -0.35355338, +1.06066012, -0.35355338, -0.17677669 };
#endif
