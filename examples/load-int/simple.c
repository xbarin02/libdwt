...
int main(int argc, char *argv[])
{
	...
	if( dwt_util_load_from_pgm_i(path, 255, &data1, &stride_x, &stride_y, &x, &y) )
	{
	...
	dwt_util_copy_i(data1, data2, stride_x, stride_y, x, y);
	...
	// forward transform
	dwt_cdf97_2f_i(data1, stride_x, stride_y, x, y, x, y, &j, 0, 0);
	...
	dwt_util_conv_show_i(data1, data3, stride_x, stride_y, x, y);
	...
	// inverse transform
	dwt_cdf97_2i_i(data1, stride_x, stride_y, x, y, x, y, j, 0, 0);
	...
	dwt_util_save_to_pgm_i("data3.pgm", 255, data3, stride_x, stride_y, x, y);
