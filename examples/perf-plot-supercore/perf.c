...
int main()
{
...
#endif
	{
		// full
		{
			do_test(min_size, max_size, opt_stride, j, 'V', ORDER_HORIZ,     0, 0); //  0
			do_test(min_size, max_size, opt_stride, j, 'V', ORDER_HORIZ_4X4, 0, 0); //  6
			do_test(min_size, max_size, opt_stride, j, 'V', ORDER_HORIZ_8X2, 0, 0); //  7
			do_test(min_size, max_size, opt_stride, j, 'V', ORDER_HORIZ_2X8, 0, 0); //  8

			do_test(min_size, max_size, opt_stride, j, 'D', ORDER_HORIZ,     0, 0); //  0
			do_test(min_size, max_size, opt_stride, j, 'D', ORDER_HORIZ_6X2, 0, 0); // 10
			do_test(min_size, max_size, opt_stride, j, 'D', ORDER_HORIZ_2X6, 0, 0); // 11
		}
	}
